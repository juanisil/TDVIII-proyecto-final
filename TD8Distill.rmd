...
![Modelo de Red de Jugadores {#fig:soccernetwork}](recursos_pdf/graficos/soccer_network.png)
...
![Resultados Modelo de Regresión Lineal {#fig:regresionlinealrp}](recursos_pdf/graficos/regresion_lineal_r_p.png)
...
![Gradiente del PSL {#fig:pslgradient}](recursos_pdf/graficos/psl_gradient.jpeg)
...
![Distribución de los $r(J, S)$ de Sergio Agüero y Robin van Persie {#fig:SergioAgueroRobinvanPersieshotsprobbetabinomial}](recursos_pdf/graficos/Sergio_Aguero_Robin_van_Persie_shots_prob_beta_binomial.png)
...
![Distribución de los $r(J, S)$ de jugadores similares a Sergio Agüero {#fig:SimilartoSergioAgueroshotsprobbetabinomial}](recursos_pdf/graficos/Similar_to_Sergio_Aguero_shots_prob_beta_binomial.png)
...
![Distribución de los $r(J, S)$ de jugadores similares a Sergio Agüero Superpuestos {#fig:SergioAgueroandsimilarplayersshotsprobbetabinomial}](recursos_pdf/graficos/Sergio_Aguero_and_similar_players_shots_prob_beta_binomial.png)
...
![Distribución de los $r(J, S)$ de jugadores similares a Sergio Agüero de la misma posición {#fig:SergioAgueroandsimilarplayerssamepositionshotsprobbetabinomial}](recursos_pdf/graficos/Sergio_Aguero_and_similar_players_same_position_shots_prob_beta_binomial.png)
...
![Distribución de los parámetros $\alpha$ y $\beta$ de los $r(J, S)$ de los jugadores {#fig:ClustersofPlayersshotsprobbetabinomial}](recursos_pdf/graficos/Clusters_of_Players_shots_prob_beta_binomial.png)
...
![Distribución de los $r(J, S)$ de jugadores en clusters {#fig:ClustersofPlayersshotsprobbetabinomialdistributions}](recursos_pdf/graficos/Clusters_of_Players_shots_prob_beta_binomial_distributions.png)
...
![Matriz de Variables Aleatorias $\mathbf{R}$ {#fig:8fddde8ae6d6}](recursos_pdf/graficos/f9090710-1703-476a-b906-8fddde8ae6d6.png)
...
![Distribución del PSL del equipo Manchester City {#fig:SergioAgueroPSLDistribution}](recursos_pdf/graficos/sergio_aguero_psl_distribution.png)
...
![Ejemplo de dos distribuciones de PSL de dos formaciones distintas {#fig:PSLDistsAgueroVGiroud}](./recursos_pdf/graficos/psl_dists_aguero_v_giroud.png)
...
![Comparación de CDFs de las distribuciones de PSL de las formaciones $L_{MC}$ y $L_{MC}^{\text{Giroud}}$ {#fig:SergioAgueroOlivierGiroudCdfIntersection}](./recursos_pdf/graficos/sergio_aguero_olivier_giroud_cdf_intersection.png)
...
![Grafo de Lineup {#fig:GLTM}](recursos_pdf/graficos/G_LTM.png)
...
![Grafo de Jugadores {#fig:GTM}](recursos_pdf/graficos/G_TM.png)
...
![Grafo de Jugadores Completo {#fig:GEPL1213}](recursos_pdf/graficos/G_EPL_12_13.png)
...
![Embeddings de Jugadores en 3D {#fig:players3d}](recursos_pdf/graficos/players_3d.png)
...
![Embeddings de Jugadores en 3D - PCA a 2D {#fig:players3d2d}](recursos_pdf/graficos/players_3d_2d.png)
...
![Embeddings de Jugadores en 64D - PCA a 2D {#fig:players642d}](recursos_pdf/graficos/players_64_2d.png)
...
![Arquitectura del Modelo Base {#fig:p2vDistModelH}](recursos_pdf/graficos/p2v_dist_model_H.pdf)
...
![Arquitectura del Modelo Tuned {#fig:p2vdistmodeltunedH}](recursos_pdf/graficos/p2v_dist_model_tuned_H.pdf)
...
![Comparación de CDFs y PDFs de Welbeck y Walcott {#fig:WelbeckWalcott}](recursos_pdf/graficos/Welbeck_Walcott.png)
...
![Comparación de CDFs y PDFs de Welbeck y Giroud {#fig:WelbeckGiroud}](recursos_pdf/graficos/Welbeck_Giroud.png)
...
![Valor de Mercado de Danny Welbeck en el Arsenal - Fuente: Transfermarkt {#fig:WelbeckMarketValue}](recursos_pdf/graficos/evolucion_valor_mercado_wellbeck.png)
...
![Comparación de CDFs y PDFs de Milner y Gerrard {#fig:MilnerGerrard}](recursos_pdf/graficos/Milner_Gerrard.png)
...
![Comparación de CDFs y PDFs de Milner y Downing {#fig:MilnerDowning}](recursos_pdf/graficos/Milner_Downing.png)
...
![Valor de Mercado de James Milner en el Liverpool - Fuente: Transfermarkt {#fig:MilnerMarketValue}](recursos_pdf/graficos/evolucion_valor_mercado_milner.png)
...
![Distribución de los $r(J, S)$ de los 10 jugadores con mayor cantidad de disparos {#fig:Top10bycountsplayersshotsprobbetabinomial}](recursos_pdf/graficos/Top_10_by_counts_players_shots_prob_beta_binomial.png)
...
![Distribución de los $r(J, S)$ de los 10 jugadores con mayor sesgo {#fig:Top10byskewplayersshotsprobbetabinomial}](recursos_pdf/graficos/Top_10_by_skew_players_shots_prob_beta_binomial.png)
...
![Top 20 Delanteros con distribución Beta más sesgada a la derecha - EPL 12/13 {#fig:Top20Forwardsbyskewplayersshotsprobbetabinomial}](recursos_pdf/graficos/Top_20_Forwards_by_skew_players_shots_prob_beta_binomial.png)
...
![Distribución de los $r(J, S)$ de los 10 jugadores con mayor suma {#fig:Top10bysumplayersshotsprobbetabinomial}](recursos_pdf/graficos/Top_10_by_sum_players_shots_prob_beta_binomial.png)
